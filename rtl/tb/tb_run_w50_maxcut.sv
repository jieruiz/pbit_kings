...
module tb_run_w50_maxcut;
    ...
    function automatic logic [31:0] pack_interval_word(input int unsigned base_idx);
        ...
        pack_interval_word[SWEEP_INTERVAL0_MSB:SWEEP_INTERVAL0_LSB] = w50_sweep_interval[base_idx + 0];
        pack_interval_word[SWEEP_INTERVAL1_MSB:SWEEP_INTERVAL1_LSB] = w50_sweep_interval[base_idx + 1];
    endfunction
    ...
    task automatic configure_nodes();
        for (int idx = 0; idx < W50_NUM_PHYSICAL; idx++) begin
            ...
            write_reg(A_NODE_CFG,
                      ...
                      "node cfg");
            write_reg(A_NODE_SEED, w50_node_seed[idx], "node seed");
