...
package pbit_pkg;
    ...
    parameter GLOBAL_CTRL_PACKED_WIDTH = SOFT_RESET_WIDTH + CFG_DONE_SET_WIDTH + CFG_DONE_CLEAR_WIDTH + RUN_START_WIDTH + SNAPSHOT_LATCH_WIDTH + RUN_DONE_CLEAR_WIDTH;
    ...
    parameter NODE_CMD_PACKED_WIDTH = APPLY_CFG_WIDTH + APPLY_SEED_WIDTH + LOAD_NODE_WIDTH + CLEAR_CFG_SCOPE_EN_WIDTH + CLEAR_SEED_SCOPE_EN_WIDTH + CLEAR_LOCAL_ALL_WIDTH;
    ...
    parameter EDGE_CMD_PACKED_WIDTH = APPLY_EDGE_WIDTH + CLEAR_EDGE_WIDTH;
 ...
 // Global status reg
    ...
    parameter SNAPSHOT_VALID_LSB = 3;
    parameter SNAPSHOT_VALID_MSB = SNAPSHOT_VALID_LSB + SNAPSHOT_VALID_WIDTH - 1;

    parameter GLOBAL_STATUS_PACKED_WIDTH = CFG_DONE_WIDTH + RUN_BUSY_WIDTH + RUN_DONE_WIDTH + SNAPSHOT_VALID_WIDTH;
    ...
    parameter SNAPSHOT_VALID_PACKED_LSB = RUN_DONE_PACKED_MSB + 1;
