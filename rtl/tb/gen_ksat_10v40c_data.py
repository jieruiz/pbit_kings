...
def write_svh(path, args, physical_nodes, phys_to_idx, config_edges, clear_edges,
    ...
    lines.append("")
    lines.append("logic [5:0] k10_phys_row [K10_NUM_PHYSICAL];")
    lines.append("logic [5:0] k10_phys_col [K10_NUM_PHYSICAL];")
    ...
    lines.append("logic [5:0] k10_edge_row [K10_NUM_CONFIG_EDGES];")
    lines.append("logic [5:0] k10_edge_col [K10_NUM_CONFIG_EDGES];")
    ...
    lines.append("logic [5:0] k10_clear_edge_row [K10_NUM_CLEAR_EDGES];")
    lines.append("logic [5:0] k10_clear_edge_col [K10_NUM_CLEAR_EDGES];")
