...
package pbit_pkg;
    ...
    parameter SEED_VALID_WIDTH = 1;
    parameter SEED_VALID_LSB = 1;
    parameter SEED_VALID_MSB = SEED_VALID_LSB + SEED_VALID_WIDTH - 1;
    parameter CLAMP_VALID_WIDTH = 1;
    parameter CLAMP_VALID_LSB = 2;
    parameter CLAMP_VALID_MSB = CLAMP_VALID_LSB + CLAMP_VALID_WIDTH - 1;
    parameter BIAS_VALID_WIDTH = 1;
    parameter BIAS_VALID_LSB = 3;
    ...
    parameter NODE_CFG_VALID_W = INIT_VALID_WIDTH + SEED_VALID_WIDTH + CLAMP_VALID_WIDTH + BIAS_VALID_WIDTH;
    ...
    parameter SEED_VALID_PACKED_LSB = INIT_VALID_PACKED_MSB + 1;
    parameter SEED_VALID_PACKED_MSB = SEED_VALID_PACKED_LSB + SEED_VALID_WIDTH - 1;
    parameter CLAMP_VALID_PACKED_LSB = SEED_VALID_PACKED_MSB + 1;
    ...
    parameter NUM_MAJORITY_WIDTH = $clog2(NUM_MAJORITY_MAX+1);
    ...
    parameter LOAD_CFG_WIDTH = 1;
    parameter LOAD_CFG_LSB = 1;
    parameter LOAD_CFG_MSB = LOAD_CFG_LSB + LOAD_CFG_WIDTH - 1;
    parameter CLEAR_SCOPE_EN_WIDTH = 1;
    parameter CLEAR_SCOPE_EN_LSB = 2;
    parameter CLEAR_SCOPE_EN_MSB = CLEAR_SCOPE_EN_LSB + CLEAR_SCOPE_EN_WIDTH - 1;
    parameter CLEAR_LOCAL_ALL_WIDTH = 1;
    parameter CLEAR_LOCAL_ALL_LSB = 3;
    parameter CLEAR_LOCAL_ALL_MSB = CLEAR_LOCAL_ALL_LSB + CLEAR_LOCAL_ALL_WIDTH - 1;
    parameter READBACK_NODE_WIDTH = 1;
    parameter READBACK_NODE_LSB = 4;
    parameter READBACK_NODE_MSB = READBACK_NODE_LSB + READBACK_NODE_WIDTH - 1;

    parameter NODE_CMD_PACKED_WIDTH = APPLY_CFG_WIDTH + LOAD_CFG_WIDTH + CLEAR_SCOPE_EN_WIDTH + CLEAR_LOCAL_ALL_WIDTH + READBACK_NODE_WIDTH;
    parameter APPLY_CFG_PACKED_LSB = 0;
    parameter APPLY_CFG_PACKED_MSB = APPLY_CFG_PACKED_LSB + APPLY_CFG_WIDTH - 1;
    parameter LOAD_CFG_PACKED_LSB = APPLY_CFG_PACKED_MSB + 1;
    parameter LOAD_CFG_PACKED_MSB = LOAD_CFG_PACKED_LSB + LOAD_CFG_WIDTH - 1;
    parameter CLEAR_SCOPE_EN_PACKED_LSB = LOAD_CFG_PACKED_MSB + 1;
    parameter CLEAR_SCOPE_EN_PACKED_MSB = CLEAR_SCOPE_EN_PACKED_LSB + CLEAR_SCOPE_EN_WIDTH - 1;
    parameter CLEAR_LOCAL_ALL_PACKED_LSB = CLEAR_SCOPE_EN_PACKED_MSB + 1;
    parameter CLEAR_LOCAL_ALL_PACKED_MSB = CLEAR_LOCAL_ALL_PACKED_LSB + CLEAR_LOCAL_ALL_WIDTH - 1;
    parameter READBACK_NODE_PACKED_LSB = CLEAR_LOCAL_ALL_PACKED_MSB + 1;
    parameter READBACK_NODE_PACKED_MSB = READBACK_NODE_PACKED_LSB + READBACK_NODE_WIDTH - 1;
 ...
 // Global status reg
    ...
    parameter NODE_CFG_DONE_WIDTH = 1;
    parameter NODE_CFG_DONE_LSB = 3;
    parameter NODE_CFG_DONE_MSB = NODE_CFG_DONE_LSB + NODE_CFG_DONE_WIDTH - 1;
    parameter EDGE_CFG_DONE_WIDTH = 1;
    parameter EDGE_CFG_DONE_LSB = 4;
    parameter EDGE_CFG_DONE_MSB = EDGE_CFG_DONE_LSB + EDGE_CFG_DONE_WIDTH - 1;
    ...
    parameter GLOBAL_STATUS_PACKED_WIDTH = CFG_DONE_WIDTH + RUN_BUSY_WIDTH + RUN_DONE_WIDTH + NODE_CFG_DONE_WIDTH + EDGE_CFG_DONE_WIDTH + SNAPSHOT_VALID_WIDTH + ERROR_WIDTH;
    ...
    parameter NODE_CFG_DONE_PACKED_LSB = RUN_DONE_PACKED_MSB + 1;
    parameter NODE_CFG_DONE_PACKED_MSB = NODE_CFG_DONE_PACKED_LSB + NODE_CFG_DONE_WIDTH - 1;
    parameter EDGE_CFG_DONE_PACKED_LSB = NODE_CFG_DONE_PACKED_MSB + 1;
    parameter EDGE_CFG_DONE_PACKED_MSB = EDGE_CFG_DONE_PACKED_LSB + EDGE_CFG_DONE_WIDTH - 1;
    parameter SNAPSHOT_VALID_PACKED_LSB = EDGE_CFG_DONE_PACKED_MSB + 1;
    ...
    parameter EDGE_ROW_OOR_PACKED_LSB = NODE_COL_OOR_PACKED_MSB + 1;
