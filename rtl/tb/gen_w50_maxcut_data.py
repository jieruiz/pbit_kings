...
def write_svh(path, args, W, mapping, physical_nodes, phys_to_idx, config_edges, clear_edges, node_seeds, init_spins, logical_edges, tile_info):
    ...
    lines.append("")
    lines.append("logic [NODE_TARGET_ROW_WIDTH-1:0] w50_phys_row [W50_NUM_PHYSICAL];")
    lines.append("logic [NODE_TARGET_COL_WIDTH-1:0] w50_phys_col [W50_NUM_PHYSICAL];")
    ...
    lines.append("logic [EDGE_TARGET_ROW_WIDTH-1:0] w50_edge_row [W50_NUM_CONFIG_EDGES];")
    lines.append("logic [EDGE_TARGET_COL_WIDTH-1:0] w50_edge_col [W50_NUM_CONFIG_EDGES];")
    ...
    lines.append("logic [EDGE_TARGET_ROW_WIDTH-1:0] w50_clear_edge_row [W50_NUM_CLEAR_EDGES];")
    lines.append("logic [EDGE_TARGET_COL_WIDTH-1:0] w50_clear_edge_col [W50_NUM_CLEAR_EDGES];")
