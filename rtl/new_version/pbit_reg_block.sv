...
module pbit_reg_block (
    ...
    // -------------------------------------------------------------------------
    // Hold edge target/cfg staging fields until software writes their own registers.
    assign cfg_edge_type_d  = reg_wdata_i[EDGE_TYPE_MSB:EDGE_TYPE_LSB];
    assign cfg_edge_type_en = (reg_addr_i == A_EDGE_TARGET) && reg_wr_en_i;
    ...
    assign cfg_edge_sign_en = (reg_addr_i == A_EDGE_CFG) && reg_wr_en_i;
    assign cfg_edge_valid_d = reg_wdata_i[EDGE_CFG_EDGE_VALID_MSB:EDGE_CFG_EDGE_VALID_LSB];
    assign cfg_edge_valid_en = (reg_addr_i == A_EDGE_CFG) && reg_wr_en_i;
    ...
    // -------------------------------------------------------------------------
    dffe #(.WIDTH(EDGE_TYPE_WIDTH)
    ) cfg_edge_type_ff(
        .clk (clk),
        .en_i(cfg_edge_type_en),
        .d_i (cfg_edge_type_d),
        .q_o (cfg_edge_type_q)
    );
    ...
    dffe #(.WIDTH(EDGE_CFG_EDGE_SIGN_WIDTH)
    ) cfg_edge_sign_ff(
        .clk (clk),
        .en_i(cfg_edge_sign_en),
        .d_i (cfg_edge_sign_d),
        .q_o (cfg_edge_sign_q)
    );

    dffe #(.WIDTH(EDGE_CFG_EDGE_VALID_WIDTH)
    ) cfg_edge_valid_ff(
        .clk (clk),
        .en_i(cfg_edge_valid_en),
